Instance: ExampleHivStatusCondition
InstanceOf: HivStatusCondition
Title: "Example HIV Status Condition"
Description: "An example of the HIV Status Condition resource."
* clinicalStatus = #active
* subject = Reference(Patient/ExampleHivPatient)
* code = HIVConcepts#HIV.B.DE115Instance: ExampleHivPositiveCondition
